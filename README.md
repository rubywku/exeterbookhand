...
The project includes the following resources:
  ...
  * **EBH Digital Edition** (in progress) – an online book-hand edition of selected poems from the Exeter Book for students and general audiences
...
EBH (short for Exeter-Book Hand) is a digital revival of the book hand found in the Exeter MS 3501. The overall shape of the script is very upright, with long ascenders and descenders and a fine balance of light and heavy strokes, whereas the ornamentation takes the form of initials made up of elements common in both Germanic and Celtic art. 
